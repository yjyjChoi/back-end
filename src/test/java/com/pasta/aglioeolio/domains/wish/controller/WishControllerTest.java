...
public class WishControllerTest extends MockBaseControllerTest {
    ...
    void deleteWish() throws Exception {
        ...
        //given
        DeleteWishRequest deleteWishRequest = new DeleteWishRequest(
            Arrays.asList(1L, 2L)
        );

        String requestBody = objectMapper.writeValueAsString(deleteWishRequest);
    ...
    void verificationWishBySoldier() throws Exception {
        ...
        String requestBody = objectMapper.writeValueAsString(verificationWishRequest);
